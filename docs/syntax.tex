...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \coordinate (mid);
    \coordinate[above=1cm of mid] (top);
    \coordinate[below=1cm of mid] (bot);

    \coordinate[left=3cm of top] (top-left);
    \coordinate[right=3cm of top] (top-right);

    \coordinate[left=3cm of bot] (bot-left);
    \coordinate[right=3cm of bot] (bot-right);
    ...
    \draw [narr, mid arrow = 0.2, mid arrow = 0.7]
      (dotdot)
      -| (bot-left)
      -| (entry-loop)
      -- ++(0.2, 0);
    ...
    \draw [narr, mid arrow = 0.8, mid arrow = 0.3]
      (exit-loop) + (-0.2, 0)
      -- (exit-loop)
      |- (bot-right)
      |- (dotdot);
